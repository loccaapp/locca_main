...
public class SendEmail3 implements RequestHandler<MailingInDTO, BaseOutDTO> {

    @Override
    public BaseOutDTO handleRequest(MailingInDTO input, Context context) {
        ...
        String BODY = "Heyy LOCCA \n \n This email was sent through the Amazon SES SMTP interface by using Java.";
        String SUBJECT = "Amazon SES test (SMTP interface accessed using Java)";
        
        // Supply your SMTP credentials below. Note that your SMTP credentials are different from your AWS credentials.
        String SMTP_USERNAME = input.from_email_address;  // Replace with your SMTP username.
        String SMTP_PASSWORD = input.smtp_pwd;  // Replace with your SMTP password.
        
        // Amazon SES SMTP host name. This example uses the US West (Oregon) region.
        // String HOST = "email-smtp.us-west-2.amazonaws.com";    
        String HOST = input.smtp_email;
        
        FROM = input.from_email_address;
        TO = input.to_email_address;
